...
import (
	...
	_ "ccsync_backend/docs" // This will be generated by swag init
)
...
// @contact.email support@ccsync.com
...
func main() {
	...
	log.Println("Swagger documentation available at http://localhost:8000/swagger/index.html")
