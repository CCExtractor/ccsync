...
func TestAddTaskToTaskwarrior(t *testing.T) {
	err := AddTaskToTaskwarrior("email", "encryption_secret", "clientId", "description", "", "H", "2025-03-03", "2025-03-01", "2025-03-05", "daily", nil, []models.Annotation{{Description: "note"}})
	if err != nil {
...
func TestAddTaskWithTags(t *testing.T) {
	err := AddTaskToTaskwarrior("email", "encryption_secret", "clientId", "description", "", "H", "2025-03-03", "2025-03-01", "2025-03-05", "daily", []string{"work", "important"}, []models.Annotation{{Description: "note"}})
	if err != nil {
