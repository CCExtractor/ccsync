...
jest.mock('../faq-utils', () => ({
    FAQList: [
        { question: 'What is React?', answer: 'A JavaScript library for building user interfaces.', value: 'q1' },
        { question: 'What is TypeScript?', answer: 'A typed superset of JavaScript that compiles to plain JavaScript.', value: 'q2' }
    ]
}));
